...
;+((a) => {
  ...
  ;(a.fn.emulateTransitionEnd = function (b) {
    ...
    var e = () => {
      c || a(this).trigger(a.support.transition.end)
    }
          ...
          j.isDefaultPrevented()
            ...
            : ((this.sliding = !0),
              ...
              this.$indicators.length &&
                ...
                this.$element.one("slid.bs.carousel", () => {
                  var b = a(this.$indicators.children()[this.getActiveIndex()])
                  b && b.addClass("active")
                })),
  ...
  +((a) => {
    ...
    ;(b.DEFAULTS = { backdrop: !0, keyboard: !0, show: !0 }),
      ...
      (b.prototype.show = function (b) {
        ...
        this.$element.trigger(d),
          this.isShown ||
            ...
            this.backdrop(() => {
              var d = a.support.transition && this.$element.hasClass("fade")
              this.$element.parent().length || this.$element.appendTo(document.body),
                this.$element.show().scrollTop(0),
                d && this.$element[0].offsetWidth,
                this.$element.addClass("in").attr("aria-hidden", !1),
                this.enforceFocus()
      ...
      (b.prototype.hideModal = function () {
        ...
        this.$element.hide(),
          this.backdrop(() => {
            this.removeBackdrop(), this.$element.trigger("hidden.bs.modal")
          })
      }),
  ...
  +((a) => {
    ...
    ;(b.DEFAULTS = {
      ...
      (b.prototype.getDefaults = () => b.DEFAULTS),
      ...
      (b.prototype.applyPlacement = function (b, c) {
        var d,
          ...
          f = e[0].offsetWidth,
          g = e[0].offsetHeight,
          h = Number.parseInt(e.css("margin-top"), 10),
          i = Number.parseInt(e.css("margin-left"), 10)
        isNaN(h) && (h = 0),
          isNaN(i) && (i = 0),
          (b.top = b.top + h),
          (b.left = b.left + i),
      ...
      (b.prototype.getCalculatedOffset = (a, b, c, d) =>
        "bottom" == a
