...
;((global, factory) => {
  ...
  jQuery.extend({
    ...
    isNumeric: (obj) => {
      ...
      return obj - Number.parseFloat(obj) >= 0
    },
  ...
  var Sizzle = ((window) => {
    ...
    Expr = Sizzle.selectors = {
      ...
      pseudos: {
        ...
        contains: markFunction(
          (text) => (elem) => (elem.textContent || elem.innerText || getText(elem)).indexOf(text) > -1,
        ),
    ...
    function matcherFromTokens(tokens) {
      var checkContext,
        ...
        matchAnyContext = addCombinator((elem) => indexOf.call(checkContext, elem) > -1, implicitRelative, true),
        matchers = [
          (elem, context, xml) =>
  ...
  jQuery.extend({
    ...
    data: (elem, name, data) => internalData(elem, name, data),

    removeData: (elem, name) => internalRemoveData(elem, name),

    // For internal use only.
    _data: (elem, name, data) => internalData(elem, name, data, true),

    _removeData: (elem, name) => internalRemoveData(elem, name, true),
  })
  ...
  if (window.getComputedStyle) {
    getStyles = (elem) => elem.ownerDocument.defaultView.getComputedStyle(elem, null)
    ...
    jQuery.extend(support, {
      ...
      reliableMarginRight: () => {
        ...
        if (reliableMarginRightVal == null && window.getComputedStyle) {
          ...
          reliableMarginRightVal = !Number.parseFloat((window.getComputedStyle(marginDiv, null) || {}).marginRight)
  ...
  if (!support.hrefNormalized) {
    ...
    jQuery.each(["href", "src"], (i, name) => {
      jQuery.propHooks[name] = {
        get: (elem) => elem.getAttribute(name, 4),
      }
    })
  }
